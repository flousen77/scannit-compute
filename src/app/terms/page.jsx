  ...
  return (
    <main className="max-w-4xl mx-auto py-20 px-6 text-slate-300 leading-relaxed">
      ...
      <div className="space-y-6 text-slate-400">
        ...
        <h2 className="text-xl font-semibold text-white mt-8">2. Third-Party Data Disclosures</h2>
        ...
        <h2 className="text-xl font-semibold text-white mt-8">3. Lawful Basis for Processing (GDPR/EU)</h2>
        ...
        <h2 className="text-xl font-semibold text-white mt-8">4. Your Rights (DSGVO/GDPR)</h2>
        ...
        <h2 className="text-xl font-semibold text-white mt-8">5. Data Retention and Deletion</h2>
