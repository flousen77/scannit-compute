  ...
  return (
    <main className="max-w-4xl mx-auto py-20 px-6 text-slate-800 leading-relaxed">
      ...
      <div className="space-y-6 text-slate-600">
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">3. Acceptable Use Policy (AUP)</h2>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">4. Limitation of Liability and SLAs</h2>
        ...
        <h2 className="text-xl font-semibold text-slate-900 mt-8">5. Account and Billing</h2>
